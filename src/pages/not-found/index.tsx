...
import InfoIcon from 'shared/assets/img/info.svg?react';
import rat from 'shared/assets/img/rat.gif';
...
export default function NotFoundPage() {
    ...
    const handleRat = () => {
        const otherTips = RAT_TIPS.filter(
            (tip) => tip.code !== currentTip.code,
        );
